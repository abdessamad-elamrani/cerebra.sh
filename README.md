...
See how Cerebra compares across the workflows that matter for cybersecurity operators: multi-protocol access, browser workflows, pane templates, runbooks, reverse engineering, graphing, notes, and AI with live control.

<p align="center">
  <a href="screenshots/comparison-table.png">
    <img src="screenshots/comparison-table.png" alt="Cerebra comparison table" width="1200" />
  </a>
</p>
